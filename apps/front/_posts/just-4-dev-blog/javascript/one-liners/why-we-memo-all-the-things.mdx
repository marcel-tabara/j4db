...
date: Tue Jan 25 2022 19:06:16 GMT-0500 (Eastern Standard Time)
image: /assets/post2.png
tags: debugging performance issues,premature optimization,profiling,react memo,usecallback,usememo
slug: why-we-memo-all-the-things
author1: just4.dev
---
...
Running a render function
Allocating all callbacks anew
Allocating all useMemo functions anew
Allocating a bunch of new JSX elements
Repeating 1–4 recursively for all the children
Causing the React reconciler to compare the old tree with the new tree
